...
data_sim = np.loadtxt('Escogio el metodo PI Control Pole Assignment.txt',delimiter=',',skiprows=1)
t_sim = data_sim[:,0].T 
u_sim = data_sim[:,1].T
y_sim = data_sim[:,2].T
r_sim = data_sim[:,3].T
...
# Cargar datos reales
data_real = np.loadtxt('Real PI Control Pole Assignment.txt',delimiter=',',skiprows=1)
