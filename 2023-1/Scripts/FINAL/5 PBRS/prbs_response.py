# -*- coding: utf-8 -*-
"""
Created on Mon Mar 27 21:03:47 2023
...
def save_txt(t, u1, y1):
    ...
    np.savetxt('prbsResponse_25.txt', data, delimiter=',',header = top, comments='')
...
# Temperature (C)
T1 = np.ones(loops) * lab.T3

# Manipulated variable (0 - 100)
Q1 = create_prbs(0, 5, 25, 10, 50, loops-30, 30);
...
try:
    for k in range(1, loops):
        ...
        ax = plt.subplot(211)
        plt.title('Signal PBRS', fontsize=14)
        ax.grid()
